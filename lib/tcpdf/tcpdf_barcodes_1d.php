...
class TCPDFBarcode {
	...
	public function setBarcode($code, $type) {
		switch (strtoupper($type)) {
			...
			case 'MSI+': { // MSI + CHECKSUM (module 11)
	...
	/**
	 * Calculate CODE 39 checksum (module 43).
	 * @param $code (string) code to represent.
	...
	/**
	 * Calculate CODE 93 checksum (module 47).
	 * @param $code (string) code to represent.
	 ...
	 * @param $code (string) code to represent.
	 * @param $checksum (boolean) if true add a checksum to the code (module 11)
	 * @return array barcode representation.
	 * @protected
	 */
