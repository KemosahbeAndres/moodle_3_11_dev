...
class copy_helper_test extends \advanced_testcase {
    ...
    public function test_cleanup_orphaned_copy_controllers() {
        ...
        // Delete one of the restore controller. Simulates a situation where copy creation
        ...
        // Create some backup/restore controller that are unrelated to course copies.
        ...
        // Verify other controller remain untouched.
        ...
        // Verify that the unrelated controller remain unchanged.
    ...
    public function test_create_copy() {
        ...
        // Load the controller, to extract the data we need.
    ...
    public function test_get_copies_invalid_state() {
        ...
        // Verify get_copies gives back both backup controller.
        $this->assertEqualsCanonicalizing([$result['backupid'], $result2['backupid']], array_column($copies, 'backupid'));

        // Set one of the backup controller to failed, this should cause it to not be present.
        ...
        // Verify both backup controller are back.
        $this->assertEqualsCanonicalizing([$result['backupid'], $result2['backupid']], array_column($copies, 'backupid'));
